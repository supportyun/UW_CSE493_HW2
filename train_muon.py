...
def train(seed, n_layer, data_dir, op, p):
    ...
    optimizer = model.configure_optimizers_muon(WEIGHT_DECAY, MUON_LEARNING_RATE, ADAMW_LEARNING_RATE, BETAS, DEVICE)
    ...
    tag = f"{op}_mod_{p}_seed{seed}_layer{n_layer}_muon_lr{MUON_LEARNING_RATE}"
